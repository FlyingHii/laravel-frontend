...
<html lang="{{ config('app.locale') }}">
    ...
    <body @if (core()->getCurrentLocale() && core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
        ...
        <script type="text/javascript" src="{{ asset('vendor/webkul/admin/assets/js/admin.js?v=10') }}"></script>
        <script type="text/javascript" src="{{ asset('vendor/webkul/ui/assets/js/ui.js?v=10') }}"></script>
        <script type="text/javascript">
